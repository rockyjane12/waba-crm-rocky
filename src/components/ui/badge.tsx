...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold [transition:colors_300ms_ease-in-out] focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
        ...
        success:
          "border-transparent bg-green-500 text-white hover:bg-green-600 shadow-soft",
        warning:
